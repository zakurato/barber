...
<body>
    ...
    <h1 style="text-align: center">Crear Horarios de trabajo</h1>
    <div style="height: 30px"></div>
    ...
    <div style="display: flex;">
        ...
        <select id="selectHoraFin" class="form-select" aria-label="Default select example" style="width: 250px">
            <option selected>Seleccione la hora final</option>
            <option value="1 am.">1 am.</option>
            <option value="2 am.">2 am.</option>
            <option value="3 am.">3 am.</option>
            <option value="4 am.">4 am.</option>
    ...
    <script>
        ...
        selectDia.addEventListener("change", function() {
            // Este código se ejecutará cuando se produzca un cambio en el select
            var diaSeleccionado = selectDia.value; // Obtiene el valor seleccionado
    ...
    <script>
        ...
        selectHoraInicio.addEventListener("change", function() {
            // Este código se ejecutará cuando se produzca un cambio en el select
            var horaInicioSeleccionado = selectHoraInicio.value; // Obtiene el valor seleccionado
            var labelHoraInicio = document.getElementById("labelHoraInicio");
            var inputHoraInicio = document.getElementById("inputHoraInicio");
            labelHoraInicio.innerText = "de " + horaInicioSeleccionado;
            inputHoraInicio.value = horaInicioSeleccionado;
        });
    </script>
    ...
    <script>
        ...
        selectHoraFin.addEventListener("change", function() {
            // Este código se ejecutará cuando se produzca un cambio en el select
            var horaFinSeleccionado = selectHoraFin.value; // Obtiene el valor seleccionado
            var labelHoraFin = document.getElementById("labelHoraFin");
            var inputHoraFin = document.getElementById("inputHoraFin");
            labelHoraFin.innerText = "a " + horaFinSeleccionado;
            inputHoraFin.value = horaFinSeleccionado;
        });
    </script>
